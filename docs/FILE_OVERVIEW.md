...
- `Marketing/` — marketing, SEO, and analytics playbooks (Markdown + PDFs).
- `handoff/` — maintenance plan, installation guide, asset manifest, branch catalog.
...
- `package-handoff.sh` — produces `.tar.gz`/`.zip` archives without Git metadata.
...
## Marketing (`Marketing/`)
- `README.md` — orientation for marketing workspace.
- `core/` — canonical marketing narrative (`SEO&MARKETING.MD`).
- `playbooks/` — channel, growth, analytics, and reporting guides.
- `deliverables/` — submission-ready Markdown + PDFs and `render_pdfs.sh`.

## Handoff (`handoff/`)
- `README.md` — starting point for final handoff deliverable.
- `INSTALLATION.md` — local/staging/prod installation instructions.
- `MAINTENANCE_PLAN.md` — operational cadence and responsibilities.
- `ASSET_MANIFEST.md` — inventory of all submitted artefacts.
- `BRANCH_CATALOG.md` — summary of Git branches and their status.
